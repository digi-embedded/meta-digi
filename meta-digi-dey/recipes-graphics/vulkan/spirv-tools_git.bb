...
SRC_URI = "git://github.com/KhronosGroup/SPIRV-Tools;nobranch=1;protocol=http;name=spirv-tools \
           git://github.com/KhronosGroup/SPIRV-Headers;nobranch=1;name=spirv-headers;destsuffix=${SPIRV_HEADERS_LOCATION} \
