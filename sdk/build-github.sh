...
#  build-github.sh
#
#  Copyright (C) 2015-2019 by Digi International Inc.
#  All rights reserved.
#
...
AVAILABLE_PLATFORMS="ccimx8mn-dvk ccimx8x-sbc-pro ccimx8x-sbc-express ccimx6qpsbc ccimx6sbc ccimx6ulsbc ccimx6ulstarter"
