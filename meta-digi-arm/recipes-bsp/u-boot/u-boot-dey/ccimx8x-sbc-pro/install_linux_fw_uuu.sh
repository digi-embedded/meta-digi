...
INSTALL_LINUX_FILENAME="${BASEFILENAME}-ccimx8x-sbc-pro.boot.vfat"
INSTALL_RECOVERY_FILENAME="${BASEFILENAME}-ccimx8x-sbc-pro.recovery.vfat"
INSTALL_ROOTFS_FILENAME="${BASEFILENAME}-ccimx8x-sbc-pro.ext4"
