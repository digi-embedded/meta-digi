...
INSTALL_LINUX_FILENAME="${BASEFILENAME}-ccimx6ulsbc.boot.ubifs"
INSTALL_RECOVERY_FILENAME="${BASEFILENAME}-ccimx6ulsbc.recovery.ubifs"
INSTALL_ROOTFS_FILENAME="${BASEFILENAME}-ccimx6ulsbc.ubifs"
